...
// DefineFuncs returns all the functions to be tested as a slice
func DefineFuncs() []func() {
	return []func(){
...
// setup the whole test framework and pass it a list of functions
func TestC(t *testing.T) {
	candidates := make([]func(), 10)
	t.Log(candidates)
}
